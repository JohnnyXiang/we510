...
class Inflector  {
	...
	function __initPluralRules() {
		...
		$pluralRules = self::pushDiff($this->__pluralRules, $corePluralRules);
		$uninflected = self::pushDiff($this->__uninflectedPlural, $coreUninflectedPlural);
		$irregular = self::pushDiff($this->__irregularPlural, $coreIrregularPlural);
	 ...
	 * @link http://book.cakephp.org/2.0/en/core-utility-libraries/set.html#self::pushDiff
	 */
	...
	function __initSingularRules() {
		...
		$singularRules = self::pushDiff($this->__singularRules, $coreSingularRules);
		$uninflected = self::pushDiff($this->__uninflectedSingular, $coreUninflectedSingular);
		$irregular = self::pushDiff($this->__irregularSingular, $coreIrregularSingular);
